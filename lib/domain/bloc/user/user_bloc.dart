...
class UserBloc extends Bloc<UserEvent, UserState> {
  ...
  Future<void> _onEditProfileUser(
    ...
    try {
      ...
      final data = await userServices.editProfile(
  ...
  Future<void> _onRegisterClient(
    ...
    try {
      ...
      final data = await userServices.registerClient(event.name, event.lastname,
          event.phone, event.image, event.email, event.password, nToken!);
